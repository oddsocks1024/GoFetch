...
ENUM    NORMAL, ERR_NOMUI, ERR_NOAPP, ERR_NOREQ, ERR_NOBSD, ERR_NOCONNECT, ERR_NOICON,
        ERR_NOGAD
...
ENUM    ID_ADD=1, ID_EDIT, ID_DELETE, ID_GO, ID_OK, ID_ABORT, ID_FREQ, ID_SAVELOG,
        ...
        ID_KEYINFO, ID_MINISHOW, ID_MINIHIDE, ID_SAVEPREFS, ID_BEEPON,
...
DEF mui_addbutton,
    ...
    mui_xferslider,
    mui_prefstimeout,
    rxcommandarr[35]:ARRAY OF mui_command,
    rx_addprofilehook:hook,
    rx_quitgofetchhook:hook,
    rx_reloadprofileshook:hook,
    rx_editprofilehook:hook,
    rx_deleteprofilehook:hook,
    rx_profileshook:hook,
    rx_releasehook:hook,
    rx_setactiveprofilehook:hook,
    rx_openaddwindowhook:hook,
    rx_openeditwindowhook:hook,
    rx_lockguihook:hook,
    rx_unlockguihook:hook,
    rx_saveloghook:hook,
    rx_clearloghook:hook,
    rx_iconifyhook:hook,
    rx_uniconifyhook:hook,
    rx_iconifystatushook:hook,
    rx_getanonhook:hook,
    rx_getdownloadpathhook:hook,
    rx_gohook:hook,
    rx_addanonprofilehook:hook,
    rx_stophook:hook,
    rx_addsitehook:hook,
    rx_windowopenhook:hook,
    rx_addhttpprofilehook:hook,
    rx_setminiloghook:hook,
    rx_annotatehook:hook,
    rx_clearhistoryhook:hook,
    rx_returnprotohook:hook,
    rx_edithttpprofilehook:hook,
    rx_registeredhook:hook,
    rx_dlstatushook:hook,
    bm,
    menu,
    profnum,
    result,
...
installhook (rx_addprofilehook , {rx_addprofile} )
installhook (rx_quitgofetchhook, {rx_quitgofetch} )
installhook (rx_reloadprofileshook, {rx_reloadprofiles} )
installhook (rx_editprofilehook, {rx_editprofile} )
installhook (rx_deleteprofilehook, {rx_deleteprofile} )
installhook (rx_profileshook, {rx_profiles})
installhook (rx_releasehook, {rx_release})
installhook (rx_setactiveprofilehook, {rx_setactiveprofile} )
installhook (rx_openaddwindowhook, {rx_openaddwindow} )
installhook (rx_openeditwindowhook, {rx_openeditwindow} )
installhook (rx_lockguihook, {rx_lockgui})
installhook (rx_unlockguihook, {rx_unlockgui})
installhook (rx_saveloghook, {rx_savelog})
installhook (rx_clearloghook, {rx_clearlog})
installhook (rx_iconifyhook, {rx_iconify})
installhook (rx_uniconifyhook, {rx_uniconify})
installhook (rx_iconifystatushook, {rx_iconifystatus})
installhook (rx_getanonhook, {rx_getanon})
installhook (rx_getdownloadpathhook, {rx_getdownloadpath})
installhook (rx_gohook, {rx_go})
installhook (rx_addanonprofilehook, {rx_addanonprofile})
installhook (rx_stophook, {rx_stop})
installhook (rx_addsitehook, {rx_addsite})
installhook (rx_windowopenhook, {rx_windowopen})
installhook (rx_addhttpprofilehook, {rx_addhttpprofile} )
installhook (rx_setminiloghook, {rx_setminilog} )
installhook (rx_annotatehook, {rx_annotate} )
installhook (rx_clearhistoryhook, {rx_clearhistory})
installhook (rx_returnprotohook, {rx_returnproto})
installhook (rx_edithttpprofilehook, {rx_edithttpprofile})
installhook (rx_registeredhook, {rx_registered})
installhook (rx_dlstatushook, {rx_dlstatus})
...
rxcommandarr[29].mc_hook:=rx_edithttpprofilehook

rxcommandarr[29].mc_name:='registered'
rxcommandarr[29].mc_template :=NIL
rxcommandarr[29].mc_parameters:=NIL
rxcommandarr[29].mc_hook:=rx_registeredhook

rxcommandarr[30].mc_name:='dlstatus'
rxcommandarr[30].mc_template :=NIL
rxcommandarr[30].mc_parameters:=NIL
rxcommandarr[30].mc_hook:=rx_dlstatushook
...
mui_addbutton:=make_button('_Add', 'Add Profile')
mui_editbutton:=make_button('_Edit', 'Edit Profile')
mui_deletebutton:=make_button('_Delete', 'Delete Profile')
bm:=imgLogoObject()
mui_stopbutton:=make_button('_Stop', 'Stop Downloading Files')
mui_gobutton:=make_button('_Go!', 'Start Downloading Files')
mui_quitbutton:=make_button('_Quit', 'Quit Go Fetch!')
mui_savelogbutton:=make_button('Sa_ve Log', 'Save contents of log view')
mui_showminilog:=make_ibutton(MUII_PopUp, 'Show or Hide Mini-Log window' ,MUIV_InputMode_Toggle)
mui_clearlogbutton:=make_button('_Clear Log', 'Clear contents of log view')
...
mui_clearhistbutton:=make_button('Clear _History', 'Clear contents of history view')

/* Gadgets for the preferences page */
...
mui_prefsbeep:= make_checkmark(MUI_TRUE, 'Beep on completed transfer')
mui_prefskeepalive:= make_checkmark(MUI_TRUE, 'Keep connection alive if the\nnext profile is on the same server')
mui_prefsshowprofs:= make_checkmark(MUI_TRUE, 'Show profiles list when connected')
mui_prefsretain:= make_checkmark(MUI_TRUE, 'Retain profiles which failed to connect')
mui_prefsretaintout:= make_checkmark(MUI_TRUE, 'Retain profiles which timed out')
mui_prefsretainfnf:= make_checkmark(MUI_TRUE, 'Retain profiles if the file is not found')
mui_prefsgetonnoresume:= make_checkmark(MUI_TRUE, 'Restart the file download if\nserver does not support resuming')
mui_prefssavebutton:=make_button('Sa_ve Prefs', 'Save the preferences')
mui_prefsfreqbutton:=make_ibutton(MUII_PopFile, 'Default Download directory', MUIV_InputMode_RelVerify)


/*Main Application Setup*/

app:=ApplicationObject,
    MUIA_Application_Title      , 'Go Fetch!',
    MUIA_Application_Version    , '$VER: Go Fetch! 1.3',
    MUIA_Application_Copyright  , 'Freeware',
    MUIA_Application_Author     , 'Ian Chapman',
    MUIA_Application_Description, 'FTP/HTTP Client',
                ...
                Child, VGroup,
                    ...
                    Child, ColGroup(2),
                        ...
                        Child, mui_xferslider:=SliderObject,
                            MUIA_CycleChain, 1,
                            MUIA_ShortHelp, 'Sets the transfer buffer size\n(Default 100K)',
                            MUIA_Slider_Min, 1,
                        ...
                        Child, mui_prefstimeout:=SliderObject,
                            MUIA_CycleChain, 1,
                            MUIA_ShortHelp, 'Sets the receiving timeout in seconds.\n(Default 20 seconds)',
                            MUIA_Slider_Min, 1,
                            MUIA_Slider_Max, 100,
    ...
    SubWindow, mui_addwindow:= WindowObject,
        MUIA_Window_Title       ,'Profile',
        MUIA_HelpNode           , 'Add Window',
        MUIA_Window_ID          , "ADDW",
        WindowContents, VGroup,
            Child, Label('\ecChoose Protocol of Profile:-'),
            Child, RegisterGroup(mui_addpages),
            Child, VGroup,
                ...
                Child, ColGroup(2),
                    ...
                    Child, HGroup,
                        Child, mui_sitestring:= StringObject, StringFrame,
                            ...
                            MUIA_String_Reject, '#',
                            End,
                        Child,  mui_addsitebutton:=make_ibutton(MUII_ArrowRight, 'Add to the site directory', MUIV_InputMode_RelVerify),
                        Child,  mui_sitedirbutton:=make_ibutton(MUII_PopUp, 'Show or Hide Site Directory', MUIV_InputMode_Toggle),
                    End,
                End,
            End,
            ...
            Child,  mui_sitedirlv:=ListviewObject,
                                ...
                                MUIA_Listview_List, mui_sitedirlist:=ListObject,
                                    ...
                                    End,
                              End,
                Child, mui_delsitebutton:=make_button('_Delete Site from Directory', 'Delete Site From Directory'),
            ...
            Child, HGroup,
                Child, ColGroup(2),
                    ...
                    Child, HGroup,
                        ...
                        Child, mui_checkmark:=make_checkmark(FALSE, 'Perform anonymous login'),
                    End,
                    ...
                    Child, HGroup,
                        Child, mui_localpathstring:= StringObject, StringFrame,
                            ...
                            MUIA_String_Reject, '#',
                        End,
                        Child, mui_freqbutton:=make_ibutton(MUII_PopFile, 'Choose download directory', MUIV_InputMode_RelVerify),
                    End,
                End,
            End,

            Child, HGroup,
                Child, mui_okbutton:= make_button('_OK', 'Save FTP profile'),
                Child, mui_cancelbutton:= make_button('_Cancel', 'Discard FTP profile'),
            End,
                ...
                Child, ColGroup(2),
                    ...
                    Child, HGroup,
                        Child, mui_httplocalpathstring:= StringObject, StringFrame,
                            ...
                            MUIA_String_Reject, '#', 
                        End,
                       Child, mui_httpfreqbutton:=make_ibutton(MUII_PopFile, 'Choose download directory', MUIV_InputMode_RelVerify),
                    End,
            ...
            Child, HGroup,
                Child, mui_httpokbutton:= make_button('_OK', 'Save HTTP profile'),
                Child, mui_httpcancelbutton:= make_button('_Cancel', 'Discard HTTP profile'),
            End,
...
doMethodA(app, [MUIM_MultiSet, MUIA_ShowMe, FALSE, mui_sitedirlv, mui_delsitebutton, NIL])
...
result:= doMethodA(app, [MUIM_Application_Input,{signal}])
    ...
    SELECT result
        ...
        CASE ID_ABOUT -> About menu option
            Mui_RequestA(app, mui_mainwindow, 0, 'About Go Fetch!','*_OK','\ecGo Fetch! Download Manager.\nVersion 1.3\n\nThanks to:\nMarc Bradshaw & Contributors for AREXX Scripts\n\nAREXX PORT: GOFETCH',NIL)

        CASE ID_ICONIFY -> Iconify menu option
            set(app, MUIA_Application_Iconified, MUI_TRUE)

        CASE ID_KEYINFO
            Mui_RequestA(app, mui_mainwindow, 0, 'Registration Information', '*_OK',key_string,NIL)
        ...
        CASE ID_GO  -> Go Button on main window
            ...
            doMethodA(app, [MUIM_MultiSet, MUIA_Disabled, MUI_TRUE, mui_addbutton, mui_editbutton, mui_gobutton, mui_deletebutton, mui_savelogbutton, mui_clearlogbutton, mui_quitbutton, NIL])
            ...
            doMethodA(app, [MUIM_MultiSet, MUIA_Disabled, FALSE, mui_addbutton, mui_editbutton, mui_gobutton, mui_deletebutton, mui_savelogbutton, mui_clearlogbutton, mui_quitbutton, NIL])
            set(mui_stopbutton, MUIA_Disabled, MUI_TRUE)
        ...
        CASE ID_POPSITEDIR -> Popup site dir button on add window
            doMethodA(app, [MUIM_MultiSet, MUIA_ShowMe, MUI_TRUE, mui_sitedirlv, mui_delsitebutton, NIL])
        ...
        CASE ID_CHECKON -> Anon checkmark button on add window
            ...
            set(mui_usernamestring,MUIA_String_Contents,username)
            set(mui_passwordstring,MUIA_String_Contents,password)
            doMethodA(app, [MUIM_MultiSet, MUIA_Disabled, MUI_TRUE, mui_usernamestring, mui_passwordstring, NIL])

        CASE ID_CHECKOFF -> Anon checkmark button on add window
            doMethodA(app, [MUIM_MultiSet, MUIA_Disabled, FALSE, mui_usernamestring, mui_passwordstring, NIL])
...
SELECT exception
    ...
    CASE ERR_NOAPP
        WriteF('Unable to create application\nPossible Causes:\n   Go Fetch! is already running\n   You are low on memory\n')
    CASE ERR_NOICON
...
PROC rx_registered()
    ->Always return 1 as we no longer care if GF is registered or not.
ENDPROC 1
...
/*
** Simple macro procedure for making an image button
*/
PROC make_ibutton(image, bubble, inputmethod)
DEF ibutton
    ...
    ibutton:=ImageObject,
                ...
                MUIA_ShortHelp, bubble,
                MUIA_InputMode, inputmethod,
...
PROC make_checkmark(defvalue, bubble)
DEF checkmark

    checkmark:=CheckMark(defvalue)
    SetAttrsA(checkmark, [MUIA_ShortHelp, bubble, MUIA_CycleChain, 1, TAG_DONE])
ENDPROC checkmark
